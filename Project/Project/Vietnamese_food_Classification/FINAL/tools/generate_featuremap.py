...
def build_report(b, g , r, bias_in, index):
    ...
    contents = jinja2_template.render(k0   = "32'b" + b[0] ,k1  = "32'b" + b[1] ,k2  = "32'b" + b[2], k3 = "32'b" + b[3] ,k4  = "32'b" + b[4],k5  = "32'b" + b[5],k6  = "32'b" + b[6] ,k7  = "32'b"  + b[7],k8 = "32'b"  + b[8],
                                      ...
                                      bias = "32'b" + bias_in)
    filename = "/home/thienlong/Exercise/VIPUsingFPGA/OpenIP/data/datasets/featuremap/featuremap_conv2d_0_filter"+str(index)+".v"
    save_report(contents, filename)
    print("create  success!")

for i in range(0, filter): 
    f_b = open('/home/thienlong/Exercise/VIPUsingFPGA/OpenIP/data/datasets/kernel_layer1/conv2d_channel_0filter_'+ str(i) + '.txt', 'r')
    f_g = open('/home/thienlong/Exercise/VIPUsingFPGA/OpenIP/data/datasets/kernel_layer1/conv2d_channel_1filter_'+ str(i) + '.txt', 'r')
    f_r = open('/home/thienlong/Exercise/VIPUsingFPGA/OpenIP/data/datasets/kernel_layer1/conv2d_channel_2filter_'+ str(i) + '.txt', 'r')
    b = []
    g = []
    r = []
    for j in range(0, 9): 
