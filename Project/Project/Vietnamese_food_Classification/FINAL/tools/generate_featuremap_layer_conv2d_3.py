...
f_bias = open('/home/thienlong/Exercise/VIPUsingFPGA/OpenIP/data/datasets/bias/conv2d_3_bias.txt', 'r')
...
def build_report(c0, c1, c2, c3, c4, c5, c6, c7, c8, c9, c10, c11, c12, c13, c14, c15, bias_in, index):
    ...
    verilog_template = get_template_sample("/home/thienlong/Exercise/VIPUsingFPGA/OpenIP/vip_core/rtl/vip/featuremap_template_conv2d_3.v")
    ...
    contents = jinja2_template.render(k0   = "32'b" + c0[0] ,k1   = "32'b" + c0[1] ,k2   = "32'b" + c0[2] , k3   = "32'b" + c0[3] ,k4   = "32'b" + c0[4] ,k5   = "32'b" + c0[5] ,k6   = "32'b" + c0[6] ,k7   = "32'b" + c0[7] ,k8   = "32'b" + c0[8],
                                      ...
                                      bias = "32'b" + bias_in)
    filename = "/home/thienlong/Exercise/VIPUsingFPGA/OpenIP/vip_core/rtl/vip/featuremap/featuremap_conv2d_3_filter"+str(index)+".v"
    save_report(contents, filename)
    print("create  success!")

for i in range(0, filter): 
    f_c0  = open('/home/thienlong/Exercise/VIPUsingFPGA/OpenIP/data/datasets/kernel_layer_conv2d_3/conv2d_3_channel_0filter_'+ str(i) + '.txt', 'r')
    f_c1  = open('/home/thienlong/Exercise/VIPUsingFPGA/OpenIP/data/datasets/kernel_layer_conv2d_3/conv2d_3_channel_1filter_'+ str(i) + '.txt', 'r')
    f_c2  = open('/home/thienlong/Exercise/VIPUsingFPGA/OpenIP/data/datasets/kernel_layer_conv2d_3/conv2d_3_channel_2filter_'+ str(i) + '.txt', 'r')
    f_c3  = open('/home/thienlong/Exercise/VIPUsingFPGA/OpenIP/data/datasets/kernel_layer_conv2d_3/conv2d_3_channel_3filter_'+ str(i) + '.txt', 'r')
    f_c4  = open('/home/thienlong/Exercise/VIPUsingFPGA/OpenIP/data/datasets/kernel_layer_conv2d_3/conv2d_3_channel_4filter_'+ str(i) + '.txt', 'r')
    f_c5  = open('/home/thienlong/Exercise/VIPUsingFPGA/OpenIP/data/datasets/kernel_layer_conv2d_3/conv2d_3_channel_5filter_'+ str(i) + '.txt', 'r')
    f_c6  = open('/home/thienlong/Exercise/VIPUsingFPGA/OpenIP/data/datasets/kernel_layer_conv2d_3/conv2d_3_channel_6filter_'+ str(i) + '.txt', 'r')
    f_c7  = open('/home/thienlong/Exercise/VIPUsingFPGA/OpenIP/data/datasets/kernel_layer_conv2d_3/conv2d_3_channel_7filter_'+ str(i) + '.txt', 'r')
    f_c8  = open('/home/thienlong/Exercise/VIPUsingFPGA/OpenIP/data/datasets/kernel_layer_conv2d_3/conv2d_3_channel_8filter_'+ str(i) + '.txt', 'r')
    f_c9  = open('/home/thienlong/Exercise/VIPUsingFPGA/OpenIP/data/datasets/kernel_layer_conv2d_3/conv2d_3_channel_9filter_'+ str(i) + '.txt', 'r')
    f_c10 = open('/home/thienlong/Exercise/VIPUsingFPGA/OpenIP/data/datasets/kernel_layer_conv2d_3/conv2d_3_channel_10filter_'+ str(i) + '.txt', 'r')
    f_c11 = open('/home/thienlong/Exercise/VIPUsingFPGA/OpenIP/data/datasets/kernel_layer_conv2d_3/conv2d_3_channel_11filter_'+ str(i) + '.txt', 'r')
    f_c12 = open('/home/thienlong/Exercise/VIPUsingFPGA/OpenIP/data/datasets/kernel_layer_conv2d_3/conv2d_3_channel_12filter_'+ str(i) + '.txt', 'r')
    f_c13 = open('/home/thienlong/Exercise/VIPUsingFPGA/OpenIP/data/datasets/kernel_layer_conv2d_3/conv2d_3_channel_13filter_'+ str(i) + '.txt', 'r')
    f_c14 = open('/home/thienlong/Exercise/VIPUsingFPGA/OpenIP/data/datasets/kernel_layer_conv2d_3/conv2d_3_channel_14filter_'+ str(i) + '.txt', 'r')
    f_c15 = open('/home/thienlong/Exercise/VIPUsingFPGA/OpenIP/data/datasets/kernel_layer_conv2d_3/conv2d_3_channel_15filter_'+ str(i) + '.txt', 'r')
    c0  = []
    c1  = []
    c2  = []
    c3  = []
