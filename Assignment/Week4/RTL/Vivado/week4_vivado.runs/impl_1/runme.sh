...
HD_PWD='/home/thienlong/CE434/Assignment/Week4/RTL/Vivado/week4_vivado.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Floating_Point_RGBtoHSV.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Floating_Point_RGBtoHSV.tcl -notrace
